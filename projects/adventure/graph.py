        ...
        while q.size() > 0:
            ...
            if v not in visited:
                ...
                for next_vert in self.get_neighbors(v):
                    print(f"Current vertex neighbors: {self.get_neighbors(v)}")
                    print(f"Current next vertex: {next_vert}")
                    new_path = list(path)
                    print(f"Current new path pre-append: {new_path}")
                    
                    new_path.append(next_vert)
                    print(f"Current new path after append next vert: {new_path}")
                    q.enqueue(new_path)
